...
print('a) suma numerelor ', suma_ab)
print('b) produsul numerelor ', prod_ab)
print('c) media numerelor ', media_ab)
print('d) cel mai mare divizor comun al numerelor ', cmmdc_ab)
print('e) cel mai mic multiplu comun al numerelor ', cmmmc_ab)
print('f) minimul numerelor ', min_ab)
print('g) maximul numerelor ', max_ab)
print('h)',x,'+',y, '=', suma_ab)
print('i)',x,'*',y, '=', prod_ab)
